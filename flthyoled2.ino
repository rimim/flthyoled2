...
///               Enables Off Color                                                                           ///
///                                                                                                           ///
///       M0    - Stop playing movie [OLED]                                                                   ///
///       M1    - Play Lucasfilm credits [OLED]                                                               ///
///       M2    - Play Leia movie [OLED]                                                                      ///
///       M3    - Play Deathstar Plans movie [OLED]                                                           ///
///       M4    - Play 8mm Star Wars silent movie [OLED]                                                      ///
///       M5    - Play R2 Cartoon [OLED]                                                                      ///
///       M6    - Play BB8 Cartoon [OLED]                                                                     ///
///       M7    - Play R2 Cartoon#2 [OLED]                                                                    ///
///       M8    - Play BB8/BB-9E Cartoon [OLED]                                                               ///
///       M9    - Play Porg Cartoon [OLED]                                                                    ///
///       M10   - Play BB8 Lightsaber Cartoon [OLED]                                                          ///
///       M11   - Play R2/BB8/C3PO Cartoon [OLED]                                                             ///
///       M12   - Play BB8/Chewie Cartoon [OLED]                                                              ///
///                                                                                                           ///
...
#define OLED
#else
#define HP_FRONT_LED_PIN 9
#endif

#ifdef OLED_G2
#include <SoftwareSerial.h>
SoftwareSerial oledSerial(10, 11); // RX, TX
#endif
...
static void oledPlayMovie(uint8_t index)
{
	oledSerial.write(index);
}
#endif
...
//////////////////////////////////////////////////////////////////////
//#ifdef OLED
const byte neoJewelLEDS[HPCOUNT] = { 16, 7, 7 };
...
#if defined(OLED) || defined(OLED_G2)
  oledInit();
#endif
...
void loop(){
  ...
  if(stringComplete) {
    ...
    #endif
    else if (inputBuffer[0]=='M')                      // Movie playback
    {
    #if defined(OLED_G2)
       uint8_t movieNum = 0;
       if (inputBuffer[1] >= '0' && inputBuffer[1] <= '9')
       {
         movieNum = inputBuffer[1]-'0';
         if (inputBuffer[2] >= '0' && inputBuffer[2] <= '9')
           movieNum = movieNum*10 + inputBuffer[2]-'0';
       }
       oledPlayMovie(movieNum);
    #endif
    }
      ...
      if(commandLength >= 2)
      {
        ...
        { 
               ...
               case 3: bd2PlayMovie("Plans.bd2");
                       break;
               #elif defined(OLED_G2)
               case 2: oledPlayMovie(5);
                       break;
               case 3: oledPlayMovie(3);
                       break;
               #endif
